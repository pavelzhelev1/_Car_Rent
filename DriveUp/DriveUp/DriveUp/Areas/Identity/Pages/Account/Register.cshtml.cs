...
namespace DriveUp.Areas.Identity.Pages.Account
{
        ...
        private RentACarUser CreateUser()
        {
            ...
            catch
            {
                throw new InvalidOperationException($"Can't create an instance of '{nameof(RentACarUser)}'. " +
                    $"Ensure that '{nameof(RentACarUser)}' is not an abstract class and has a parameterless constructor, or alternatively " +
